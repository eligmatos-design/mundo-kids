...
(function () {
  ...
  function optsAvatar() {
    return {
      ...
      expressao: sessao.expressao, nome: sessao.nome
    };
  }
  ...
  function addOutro(j) {
    ...
    const m = avatar({ cor: j.cor, nome: j.nome, cabelo: j.cabelo, chapeu: j.chapeu, pele: j.pele, top: j.top, bottom: j.bottom, shoes: j.shoes, corCabelo: j.corCabelo, expressao: j.expressao });
